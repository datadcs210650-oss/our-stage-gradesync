const state={user:null,groups:new Map(),candidates:new Map(),scores:new Map(),verifications:new Map(),presence:new Map(),system:{emergencyLock:false,reason:''},selectedGroupId:null,selectedCandidateId:null,unsubs:[],pending:0};
